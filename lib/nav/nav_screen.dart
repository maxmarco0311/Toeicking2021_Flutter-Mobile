...
import 'package:toeicking2021/nav/bttom_nav_bar/bottom_nav_bar_cubit.dart';
import 'package:toeicking2021/nav/widgets/widgets.dart';
...
class NavScreen extends StatelessWidget {
  ...
  final Map<BottomNavItem, IconData> items = const {
    BottomNavItem.mode: Icons.book,
    BottomNavItem.students: MdiIcons.login,
